...
const CriarTarefa = ({ handleClose, tarefas, setTarefas }) => {
  ...
  const [prioridadeTarefa, setPrioridadeTarefa] = useState(''); // Novo estado para Prioridade
  ...
  const handlePrioridade = (event) => {
    setPrioridadeTarefa(event.target.value); // Atualiza o estado de Prioridade
  };
            ...
            <Grid item xs={2}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  label="Prioridade"
                  onChange={handlePrioridade} // Adiciona a mudança de prioridade
                  size="small"
                  sx={{
                    color: 'rgba(0, 0, 0, 0.6)',
                    fontWeight: 400,
